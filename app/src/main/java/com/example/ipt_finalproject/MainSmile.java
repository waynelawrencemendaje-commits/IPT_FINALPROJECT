...
public class MainSmile extends AppCompatActivity {

    private final Movie smile = MovieDatabase.SMILE;
        ...
        watchLaterListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (movie != null && movie.title.equals(smile.title)) {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(MainSmile.this, "Failed to load Watch Later status.", Toast.LENGTH_SHORT).show();
            }
        };
    }
