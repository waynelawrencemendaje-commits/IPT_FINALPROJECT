...
public class MainIT extends AppCompatActivity {

    private final Movie it = MovieDatabase.IT;
        ...
        watchLaterListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (movie != null && movie.title.equals(it.title)) {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(MainIT.this, "Failed to load Watch Later status.", Toast.LENGTH_SHORT).show();
            }
        };
    }
