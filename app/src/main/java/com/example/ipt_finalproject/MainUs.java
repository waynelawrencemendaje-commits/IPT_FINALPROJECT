...
public class MainUs extends AppCompatActivity {

    private final Movie us = MovieDatabase.US;
        ...
        watchLaterListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (movie != null && movie.title.equals(us.title)) {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(MainUs.this, "Failed to load Watch Later status.", Toast.LENGTH_SHORT).show();
            }
        };
    }
