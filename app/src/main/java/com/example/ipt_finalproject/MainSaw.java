...
public class MainSaw extends AppCompatActivity {

    private final Movie saw = MovieDatabase.SAW;
        ...
        watchLaterListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (movie != null && movie.title.equals(saw.title)) {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(MainSaw.this, "Failed to load Watch Later status.", Toast.LENGTH_SHORT).show();
            }
        };
    }
