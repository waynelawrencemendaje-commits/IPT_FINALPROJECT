...
public class MainMatrix extends AppCompatActivity {

    private final Movie matrix = MovieDatabase.MATRIX;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnWatchLater.setOnClickListener(v -> {
            if (isMovieInWatchLater) {
                watchLaterManager.removeMovie(matrix);
                Toast.makeText(this, "Removed from Watch Later", Toast.LENGTH_SHORT).show();
            } else {
                watchLaterManager.addMovie(matrix);
        ...
        watchLaterListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (movie != null && movie.title.equals(matrix.title)) {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(MainMatrix.this, "Failed to load Watch Later status.", Toast.LENGTH_SHORT).show();
            }
        };
    }
