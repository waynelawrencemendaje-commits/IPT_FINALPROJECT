...
public class MainMeBeforeYou extends AppCompatActivity {

    private final Movie mebeforeyou = MovieDatabase.ME_BEFORE_YOU;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnWatchLater.setOnClickListener(v -> {
            if (isMovieInWatchLater) {
                watchLaterManager.removeMovie(mebeforeyou);
                Toast.makeText(this, "Removed from Watch Later", Toast.LENGTH_SHORT).show();
            } else {
                watchLaterManager.addMovie(mebeforeyou);
        ...
        watchLaterListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (movie != null && movie.title.equals(mebeforeyou.title)) {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(MainMeBeforeYou.this, "Failed to load Watch Later status.", Toast.LENGTH_SHORT).show();
            }
        };
    }
