...
public class MainImpossible extends AppCompatActivity {

    private final Movie impossible = MovieDatabase.IMPOSSIBLE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnWatchLater.setOnClickListener(v -> {
            if (isMovieInWatchLater) {
                watchLaterManager.removeMovie(impossible);
                Toast.makeText(this, "Removed from Watch Later", Toast.LENGTH_SHORT).show();
            } else {
                watchLaterManager.addMovie(impossible);
        ...
        watchLaterListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (movie != null && movie.title.equals(impossible.title)) {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(MainImpossible.this, "Failed to load Watch Later status.", Toast.LENGTH_SHORT).show();
            }
        };
    }
