...
public class MainThree extends AppCompatActivity {
    ...
    private final Movie three = MovieDatabase.THREE_HUNDRED;
        ...
        watchLaterListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (movie != null && movie.title.equals(three.title)) {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(MainThree.this, "Failed to load Watch Later status.", Toast.LENGTH_SHORT).show();
            }
        };
    }
