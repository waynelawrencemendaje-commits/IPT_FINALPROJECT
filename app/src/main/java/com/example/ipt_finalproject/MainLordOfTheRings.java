...
public class MainLordOfTheRings extends AppCompatActivity {

    private final Movie lordoftherings = MovieDatabase.LORD_OF_THE_RINGS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnWatchLater.setOnClickListener(v -> {
            if (isMovieInWatchLater) {
                watchLaterManager.removeMovie(lordoftherings);
                Toast.makeText(this, "Removed from Watch Later", Toast.LENGTH_SHORT).show();
            } else {
                watchLaterManager.addMovie(lordoftherings);
        ...
        watchLaterListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (movie != null && movie.title.equals(lordoftherings.title)) {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(MainLordOfTheRings.this, "Failed to load Watch Later status.", Toast.LENGTH_SHORT).show();
            }
        };
    }
