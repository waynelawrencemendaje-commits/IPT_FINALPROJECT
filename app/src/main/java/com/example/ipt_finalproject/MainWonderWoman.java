...
public class MainWonderWoman extends AppCompatActivity {

    private final Movie wonderwoman = MovieDatabase.WONDER_WOMAN;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnWatchLater.setOnClickListener(v -> {
            if (isMovieInWatchLater) {
                watchLaterManager.removeMovie(wonderwoman);
                Toast.makeText(this, "Removed from Watch Later", Toast.LENGTH_SHORT).show();
            } else {
                watchLaterManager.addMovie(wonderwoman);
        ...
        watchLaterListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (movie != null && movie.title.equals(wonderwoman.title)) {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(MainWonderWoman.this, "Failed to load Watch Later status.", Toast.LENGTH_SHORT).show();
            }
        };
    }
